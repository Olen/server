import{c as p}from"./index-CcnBDz0O.chunk.mjs";import{g as T}from"./index-xFugdZPW.chunk.mjs";import{r as l,e as q,_ as g,b as s,a as h}from"./createElementId-DhjFt1I9-BDMhFiDD.chunk.mjs";import{l as w}from"./AccountOutline-B3ja5IKP.chunk.mjs";import{b as f,p as x,q as m,s as b,j as y,l as D,o as B,z as o,n as I}from"./runtime-dom.esm-bundler-BpKvjHjZ.chunk.mjs";const S=`<!--
...
`;l(),l(q);function M(a){switch(a){case"away":return s("away");case"busy":return s("busy");case"dnd":return s("do not disturb");case"online":return s("online");case"invisible":return s("invisible");case"offline":return s("offline");default:return a}}const L=["aria-hidden","aria-label","innerHTML"],_=f({__name:"NcUserStatusIcon",props:x({user:{default:void 0},ariaHidden:{type:[Boolean,String],default:!1}},{status:{},statusModifiers:{}}),emits:["update:status"],setup(a){const e=m(a,"status"),i=a,v=o(()=>e.value&&["invisible","offline"].includes(e.value)),n=o(()=>e.value&&(!i.ariaHidden||i.ariaHidden==="false")?s("User status: {status}",{status:M(e.value)}):void 0);b(()=>i.user,async r=>{if(!e.value&&r&&T()?.user_status?.enabled)try{const{data:t}=await p.get(h("/apps/user_status/api/v1/statuses/{user}",{user:r}));e.value=t.ocs?.data?.status}catch(t){w.debug("Error while fetching user status",{error:t})}},{immediate:!0});const c={online:Z,away:S,busy:P,dnd:X,invisible:u,offline:u},d=o(()=>e.value&&c[e.value]);return(r,t)=>e.value?(B(),y("span",{key:0,class:I(["user-status-icon",{"user-status-icon--invisible":v.value}]),"aria-hidden":!n.value||void 0,"aria-label":n.value,role:"img",innerHTML:d.value},null,10,L)):D("",!0)}}),N=g(_,[["__scopeId","data-v-881a79fb"]]);export{N,M as g};
//# sourceMappingURL=NcUserStatusIcon-CGEf7fej-DJhjaGkk.chunk.mjs.map
